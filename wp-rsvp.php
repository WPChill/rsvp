                ...
                <tr>
                    ...
                    <th scope="col" id="attendeeName" class="manage-column column-title" style=""><?php echo __("Attendee", 'rsvp-plugin'); ?><br />
                        <a href="admin.php?page=rsvp-top-level&amp;sort=attendee&amp;sortDirection=asc">
                            <img src="<?php echo plugins_url(); ?>/rsvp/resources/images/uparrow<?php
                        ...
                        <a href="admin.php?page=rsvp-top-level&amp;sort=attendee&amp;sortDirection=desc">
                            <img src="<?php echo plugins_url(); ?>/rsvp/resources/images/downarrow<?php
...
function rsvp_register_settings() {
	...
	wp_register_script('jquery_table_sort', plugins_url('resources/jquery.tablednd_0_5.js',RSVP_PLUGIN_FILE));
...
function rsvp_admin_scripts() {
	...
	wp_register_script('rsvp_admin', plugins_url('resources/rsvp_plugin_admin.js',RSVP_PLUGIN_FILE));
...
function rsvp_init() {
	...
	wp_register_script('rsvp_plugin', plugins_url("resources/rsvp_plugin.js", RSVP_PLUGIN_FILE));
	...
	wp_register_style('rsvp_css', plugins_url("resources/rsvp_plugin.css", RSVP_PLUGIN_FILE));
	wp_enqueue_script('jquery');
