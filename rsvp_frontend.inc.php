...
function rsvp_frontend_prompt_to_edit($attendee)
{
    ...
    $prompt .= sprintf(
        RSVP_START_PARA.$editGreeting.RSVP_END_PARA,
            ...
            for ($i = 1; $i <= $_POST['additionalRsvp']; $i++) {
                ...
                if (($i <= $numGuests) &&
                   ...
                   !empty($_POST['newAttending'.$i.'LastName'])) {
                    ...
                    $wpdb->insert(
                        ATTENDEES_TABLE,
                        array("firstName" => trim($_POST['newAttending'.$i.'FirstName']),
